...
contract MaskSaver {
    ...
    struct MaskInfo {
        ...
        address[] expDealer; // 예상유통지가 여러개 일수 있음
        address[] realDealer; // 예상유통지가 여러개 일수 있음
        address expSeller;
        address realSeller;
    }
    ...
    function getDealerName() external view returns (string memory){
        return dealers[msg.sender].dealerID;
    }
