...
let fromAddress = '0x05D38eE2B27615843961719541B3D84D63C58621';
let contractAddress = "0x666a89a43867734855736ba5437D9544a15bE6Ac";
...
async function MaskMaking(Id, supply){
	web3.eth.getTransactionCount(fromAddress, (err, txCount) =>{
		...
		const txObject = {
			...
			data: contract.methods._maskMaking(Id, fromAddress, supply).encodeABI()
		};
...
web3.eth.getTransactionCount(fromAddress, (err, txCount) =>{
	...
	const txObject = {
		...
		gasLimit: web3.utils.toHex(2100000),
		gasPrice: web3.utils.toHex(web3.utils.toWei('10', 'gwei')),
		data: contract.methods.maskListReturn(0).encodeABI()
	};
...
web3.eth.getTransactionCount(fromAddress, (err, txCount) =>{
	...
	const txObject = {
		...
		gasLimit: web3.utils.toHex(2100000),
		gasPrice: web3.utils.toHex(web3.utils.toWei('10', 'gwei')),
		data: contract.methods._maskMaking('wogmltest', fromAddress, 100).encodeABI()
	};
